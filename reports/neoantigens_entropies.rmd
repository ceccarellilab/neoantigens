...
saveRDS(peps, file="../neopeptides_predictions_no_dups_entropies_2024_09_22.rds")
write.table(peps, file="../neopeptides_predictions_no_dups_entropies_2024_09_22.tsv", sep="\t", quote = FALSE, row.names = FALSE)
```
